...
import com.jamal2367.urlradio.playback.PlayerController
...
class PlayerFragment: Fragment(), CoroutineScope,
            ...
            when (collection.stations.isNotEmpty()) {
                true -> {
                    YesNoDialog(this as YesNoDialog.YesNoDialogListener).show(
                        ...
                        messageString = getString(R.string.dialog_yes_no_message_restore_collection),
    ...
    private var mediaControllerCallback = object : MediaControllerCompat.Callback() {
        ...
        override fun onSessionReady() {
            LogHelper.d("Session ready. Update UI.")
        }

        override fun onMetadataChanged(metadata: MediaMetadataCompat?) {
            LogHelper.d("Metadata changed. Update UI.")
        }

        override fun onPlaybackStateChanged(playbackState: PlaybackStateCompat) {
            LogHelper.d("Playback State changed. Update UI.")
